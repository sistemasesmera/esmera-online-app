...
const ENROLLMENT_SELECT = `
  ...
  contracts!enrollment_id(id, status, amount, payment_type, cash_method, cash_amount, financer, financed_amount, document_url, signed_at, sent_at, docuseal_submission_id)
` as const;
