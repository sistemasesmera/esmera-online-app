...
const STATUS_VARIANT: Record<LeadStatus, string> = {
  ...
  en_contacto:    "bg-blue-100 text-blue-700 border border-blue-200 dark:bg-blue-900/60 dark:text-blue-300 dark:border-blue-800",
  oferta_enviada: "bg-violet-100 text-violet-700 border border-violet-200 dark:bg-violet-900/60 dark:text-violet-300 dark:border-violet-800",
